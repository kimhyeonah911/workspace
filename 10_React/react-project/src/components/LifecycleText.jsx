...
/*
    ...
    state값이 변경되면 리액트는 변화를 감지하고 그에 맞게 컴포넌트를 리렌더링 한다.
    ...
    DOM을 조작하거나 리소스를 정리할 수 있는 기능을 말한다.
*/
...
class LifecycleText extends Component {
    constructor(props){
        ...
        //js에서는 class에 필드 영역이 없기 때문에
        //저장하고 싶은 데이터를 state라는 객체에 key-value 형태로 저장한다.
        this.state = {
            count: 0
        }
