...
<body>
  ...
  <div class="content">
    ...
    <div class="innerOuter">
      ...
      <button class="btn btn-sm btn-primary" onclick="getAirStatus()">해당 지역 대기 오염 정보</button>
    ...
    function getAirInfo(data, callback){
      $.ajax({
        ...
        data: {
          ...
          //serviceKey: "t8s09+x6ZxtFh6rt5Au6SFgDOqSwUlNL+gk0HyoFzTPLa8h0nug+PNZXebXw4PW1GUrGBEOe3nbvfJzWZx/w8Q==",
