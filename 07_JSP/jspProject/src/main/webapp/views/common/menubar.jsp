...
<body>	
    ...
    <h1 align="center" style="color : rgb(71, 71, 71)">Welcome KH World</h1>
    	...
    	<c:choose>
	        ...
	        <form action="${pageContext.request.contextPath}/login.me" method="POST">
	            <table>
	                ...
	                <tr>
	                    <th colspan="2">
	                        <input type="submit" class="btn btn-sm btn-light" value="로그인">
	                        <input type="button" class="btn btn-sm btn-light" value="회원가입" onclick="enrollPage();">
	                    </th>
	                </tr>
	            </table>
	        </form>
    ...
    <div class="nav-area">
        ...
        <div class="menu"><a href="${pageContext.request.contextPath}/list.no?cpage=1">공지사항</a></div>
