...
<body>
    ...
    <%--
    	...
    	2. 지시어 : jsp페이지 정소에 대한 내용을 표현한다거나 또 다른 페이지를 포함할 때 사용
    	...
    	3. 액션태그 : jsp페이지에서 어떤 동작을 하도록 지시하는 태그
    	   ...
    	   >> 커스텀액션태그 : jsp페이지에서 바로 사용 불가능(별도의 라이브러리 연동이 필요)
     ...
     <h1>JSTL이란?</h1>
     <p>
     	jsp에서 자주 사용하는 기능들을 태그 형태로 제공하는 표준 라이브러리(커스텀액션태그)<br>
     	자바코드를 직접 사용하지 않고도 반복문, 조건문, 포맷처리... 쉽게 수행할 수 있음<br>
     ...
     3) 2개 파일의 .jar파일을 WEB-INF/lib 폴더에 추가
     ...
     <p>숫자, 날짜 및 시간 데이터의 출력형식을 지정할 때 사용</p>
