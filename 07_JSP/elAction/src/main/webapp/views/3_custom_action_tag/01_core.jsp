...
<body>
    ...
    <pre>
        ...
        -조건식은 test속성에 작성(단, EL구문으로 기술해야 한다.)
    </pre>
    ...
    <pre>
        ...
        향상된 for문 - (c:forEach var="변수명" items="순차적으로 접근할 객체(배열/컬렉션)" [varStatus="현재 "])
    </pre>
    ...
    <c:forEach var="i" begin="1" end="5">
        <h${i}>태그 안에서 사용</h${i}> <br>
    </c:forEach>

    <c:set var="colors" value="red, yello, green, pink" />
    colors : ${colors} <br>
