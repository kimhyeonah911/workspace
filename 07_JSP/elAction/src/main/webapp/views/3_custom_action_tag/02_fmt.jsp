...
<body>
    ...
    <p>
        숫자 데이터의 포멧(형식) 지정 <br>
        -표현하고자 하는 숫자 데이터의 형식을 통화기호, %등으로 원하는 방식에 맞게 지정하는 태그<br><br>
    ...
    percent : <fmt:formatNumber value="${num3}" type="currency" currencySymbol="$"/> <br>
    ...
    <ul>
        ...
        <li>pattern : <fmt:formatDate value="${current}" type="both" pattern="yyyy-MM-dd E요일 a HH:mm:ss"/></li>
    </ul>
</body>
</html>