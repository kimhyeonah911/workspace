...
public class Run {
	 ...
	 * 오버라이딩 전 : Object 클래스의 toString() 실행 -> 클래스명 + @ + 객체의 주소를 암호화한 16진수 값
	 * 오버라이딩 후 : Man클래스(자식클래스)의 toString()을 실행
	 * 
	 * 오버라이딩
	 * - 자식 클래스가 상속받고있는 부모 클래스의 메서드를 재정의하는 것
	...
	public static void main(String[] args) {
		...
		//객체가 생성되어있다면 객체 정보를 보기 위해서 참조 변수를 출력하는 순간 무조건 toString메서드가 호출된다.
