...
public class B_Array {
	public static void main(String[] args) {
		 ...
		 * 주소값을 담고 있는 변수는 참조변수(래퍼런스 변수)라고 표현
		 * 
		 ...
		 * */
		 ...
		 // 배열의 가장 큰 단점 - 한 번 지정된 배열의 크기는 변경이 불가
		...
		/*
		 * 연결이 끊어진 기존 배열은 Heap영역에 둥둥 떠다닌다.
		 * (어떤 변수에도 참조되지 않는 상태, 불러올 수 없는 메모리)
		 * => 일정 시간이 지나면 "GC(가비지컬렉터)"가 알아서 회수한다.
		 * => 자바에서의 "자동메모리관리" 특징 => 개발자만 코드에만 집중 할 수 있다.
		 * */
		arr = null;
