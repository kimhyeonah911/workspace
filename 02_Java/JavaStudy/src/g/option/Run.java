...
/*
 * package
 * 클래스 간의 공간적 충돌이나 접근 방법의 충돌을 막기 위해
 * 저장 위치를 구분하여 명확하게 접근할 수 있도록 해주는 것
 * 보통 네이밍 방법은 회사 도메인 역순으로 입력한다.
 * ex) 도메인 : www.kh.com -> 패키지 : com.kh.팀명(또는 프로젝트명)
 * */

/*
 * static이란 '정적인', '고정적인'이라는 의미를 가진다.
 * static 변수와 static 메서드는 정적 메모리를 사용하여 
 * 프로그램 실행시점에 따로 객체생성 없이 메모리가 생성되며, 이를 모든 객체가 공유해서 사용한다.
 * 
 * 클래스(static) 변수 : 한 클래스에서 공통적인 값을 유지해야 할 때 사용
...
public class Run {
	...
	public static void main(String[] args) {
		...
		Book b3 = new Book("혼자 공부하는 컴퓨터 구조+운영체제", " IT", "강민철", 330);
