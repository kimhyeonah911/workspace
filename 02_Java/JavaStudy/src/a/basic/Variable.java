...
public class Variable {
	...
	public static void main(String[] args) {
		...
		//참과 거짓을 표현하는 자료형으로 isTrue라는 이름의 변수를 만들어라.
		 ...
		 * 
		 * 정수 리터럴은 기본적으로 int 타입으로 간주된다.
		 * 그러나 변수의 타입에 따라서 적절하게 변환되거나 명시적으로 변환해주어야 한다.
		 * byte, short는 범위 내에 있을 경우 자동으로 변환한다.
		 * */
		byte by = 10;
		short sh = 10;
		int in = 10;
		 ...
		 * 문자열
		 * String(======객체======)
		 * 문자열 같은 경우 할당해야 할 메모리 크기가 너무 가변적이므로 원시타입이 아닌 객체로 변수를 만든다.
		 * */
		String str1 = "안녕하세요. 안녕하세요. 안녕안녕";
		String str2 = new String("문자열!!!~~~");
		String str3 = null; // String은 객체이기 때문에 기본값이 null
		...
		/*
		 * 이스케이프 시퀀스
		 * 문자열 내에서 탭, 백슬러시, 작은따옴표 등을 코드로 사용하기 위한 방식
		 * 
		 * 탭문자 \t
		 * 백슬래시 \\
		 * 작은따옴표 \'
		 ...
		 * */
		System.out.println("저는 이렇게 말 했습니다. \"저는 배가 고파요\"");
