...
public class C_Wrapper {
	 ...
	 * 
	 * => 원시타입을 객체로 표현해야 할 경우
	 *    - 메서드 호출해야 할 때 -> 메서드의 매게변수가 기본자료형이 아닌 객체타입만 요구될 때
	 *    - 다형성을 적용시키고 싶을 때 
	 */
	...
	public void method01() {
		...
		//2. 객체생성 하지 않고 곧바로 대입(AutoBoxing)
		Integer i3 = num1;
		...
		//1. 해당 그 Wrapper 클래스에서 제공하는 xxxValue() 메서드를 통해서 가능
		int num3 = i3.intValue();
		int num4 = i4.intValue();
		
		//2. 메서드 사용하지 않고 바로 대입(AutoUnboxing)
		int num5 = i3;
